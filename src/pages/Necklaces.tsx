...
export default function Necklaces() {
  ...
  const handleAddToCart = async (productId: string) => {
    try {
      ...
      toast({ title: "Produto adicionado", description: "O colar foi adicionado ao carrinho" });
    } catch (error) {
      console.error('Erro ao adicionar ao carrinho:', error);
      toast({ title: "Erro", description: "Não foi possível adicionar o colar ao carrinho", variant: "destructive" });
    }
  };
